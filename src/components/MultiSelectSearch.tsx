    ...
    <div className="w-full">
      ...
      <div
        ...
        className={`min-h-[48px] w-full border border-gray-300 rounded-lg px-3 py-2 bg-white cursor-text transition-colors ${
          isLoading
            ? "opacity-50"
            : "hover:border-gray-400 focus-within:ring-2 focus-within:ring-purple-500 focus-within:border-purple-500"
        }`}
      >
        <div className="flex flex-wrap items-center gap-2">
          ...
          <input
            ...
            placeholder={
              searchTerms.length === 0 ? placeholder : "Add more keywords..."
            }
      ...
      <div className="mt-2 flex items-center justify-between">
        <div className="flex items-center space-x-4">
          ...
          {searchTerms.length > 0 && (
            <span className="text-sm text-purple-600 font-medium">
              {searchTerms.length} keyword{searchTerms.length !== 1 ? "s" : ""}{" "}
              selected
            </span>
          )}
        </div>
        ...
        <button
          ...
          className="inline-flex items-center space-x-2 bg-purple-600 hover:bg-purple-700 disabled:bg-gray-400 text-white font-medium px-4 py-2 rounded-lg transition-colors focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 disabled:cursor-not-allowed"
        >
          {isLoading ? (
            <>
